  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-2xl shadow p-6">
      ...
      {/* <div className="mb-6">
        ...
        <button
          className="w-full bg-gray-800 text-white px-4 py-3 rounded-xl hover:bg-gray-700 flex items-center justify-center space-x-2 transition-colors duration-200"
        ...
        <p className="text-xs text-gray-500 mt-2 text-center">
          {isMobile ? "Mobile Steam login" : "Desktop Steam login"}
        </p>
      </div>
